export default function AuthLayout({ children }) {
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-start py-5 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 -z-1 h-full w-full overflow-hidden opacity-20">
        <div className="absolute top-1/4 -right-32 -z-1 h-125 w-125 rounded-full bg-violet-800 mix-blend-screen blur-3xl" />
        <div className="absolute top-1/4 -left-32 -z-1 h-125 w-125 rounded-full bg-blue-500 mix-blend-screen blur-3xl" />
      </div>
      <div>
